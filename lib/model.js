...
class Model {
   ...
   * @param  {Boolean}      [options.returning=false] Return the upserted row alongside the created flag. The row comes back from the statement's own RETURNING clause, so this costs no extra query
