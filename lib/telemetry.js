 ...
 * The gauges are observed here; the two synchronous instruments are left to the caller to record,
 * because only the pool knows when an acquire finished and how it ended:
 *
 ...
 * @return {{recordWaitTime: Function, recordTimeout: Function, detach: Function}} The pool's
 *   metrics; `detach` stops reporting and should be called when the pool is closed
 */
